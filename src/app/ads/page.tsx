    ...
    return (
      <div className="min-h-screen bg-gradient-to-br from-gray-800 via-gray-700 to-gray-600 flex items-center justify-center px-4 relative overflow-hidden">
        ...
        <div className="text-center relative z-10">
          <h1 className="text-2xl font-bold mb-8 text-white drop-shadow-lg">
            Ad Entries
          </h1>
        ...
        <div className="backdrop-blur-xl bg-white/10 border border-white/20 rounded-3xl shadow-2xl p-8 mb-8 relative overflow-hidden">
          ...
          <div className="relative z-10 space-y-4">
            <p className="text-white/90 text-sm leading-relaxed">
              ...
              generation prompt. This provides valuable exposure for your
              business by potentially influencing how your product is discussed
              in news articles.
            </p>
            <p className="text-white/90 text-sm leading-relaxed">
          ...
          <div className="backdrop-blur-xl bg-white/10 border border-white/20 rounded-3xl shadow-2xl p-8 mb-8 relative overflow-hidden">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6 relative z-10">
              ...
              <div className="backdrop-blur-sm bg-white/5 border border-white/10 rounded-2xl p-6">
                ...
                <p className="text-white/80 text-sm mb-4 leading-relaxed">
                  One dynamically tuned advertisement that uses AI to adapt to
                  its context for maximum impact.
                </p>
                <ul className="text-white/70 text-sm space-y-2">
