...
async function testAdIntegration() {
  ...
  try {
    ...
    const testAd = {
      ...
      bidPrice: 10.5,
      promptContent:
        "This is a test advertisement that should appear in the article prompt every 20 messages."
    };
    ...
    const newerAd = {
      ...
      bidPrice: 15.75,
      promptContent:
        "This is the most recent advertisement that should be used in article generation."
    };
