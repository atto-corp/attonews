...
export default function PricingPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-gray-800 via-gray-700 to-gray-600 py-12 px-4 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-xl text-white/80 max-w-3xl mx-auto">
            Access AI-powered news generation with flexible pricing tiers
            designed for every level of content creation.
          </p>
        </div>
            ...
            <ul className="space-y-4 mb-8 relative z-10">
              <li className="flex items-center">
                ...
                <span className="text-white/90">
                  Read last 3 daily editions
                </span>
              </li>
              <li className="flex items-center">
                <svg
                  className="w-5 h-5 text-white/60 mr-3 flex-shrink-0"
                  fill="none"
                  stroke="currentColor"
                  viewBox="0 0 24 24"
                >
            ...
            <Link href={getButtonLink()}>
              <button className="w-full bg-gradient-to-r from-slate-500 to-slate-600 text-white py-3 px-6 rounded-xl font-semibold hover:from-slate-400 hover:to-slate-500 focus:ring-2 focus:ring-slate-400 focus:ring-offset-2 transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed transform hover:scale-105 hover:shadow-lg hover:shadow-slate-500/25 relative overflow-hidden group">
                <span className="relative z-10">
                  {getButtonText("Get Started Free")}
                </span>
        ...
        <div className="backdrop-blur-xl bg-white/10 border border-white/20 rounded-3xl shadow-2xl p-8 mb-16 relative overflow-hidden">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 relative z-10">
            ...
            <div>
              ...
              <p className="text-white/80">
                Your generated content remains accessible for 30 days after
                cancellation, giving you time to export any important articles.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="text-white/80">
                Our AI reporters can be customized with specific topics, writing
                styles, and research parameters to generate articles
                automatically.
              </p>
            </div>
            ...
            <div>
              ...
              <p className="text-white/80">
                Every article cites the specific social media messages that the
                reporter used as sources in its writing.
              </p>
            </div>
          </div>
        </div>
        ...
        <div className="text-center text-white/60 relative z-10">
          <p>
            All plans include our standard terms of service and privacy policy.
          </p>
        </div>
      </div>
    </div>
